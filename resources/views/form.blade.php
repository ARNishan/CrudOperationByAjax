        ...
        <form method="POST">
            @csrf {{ method_field('POST') }}
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="form_tags" name="form_tags" placeholder="Tags">
              </div>
...
<div class="modal fade" id="single-data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
      <li class="list-group-item">ID: <span class="text-danger" id="postid"></span></li>
      <li class="list-group-item">Title: <span class="text-danger" id="title"></span> </li>
      <li class="list-group-item">Author: <span class="text-danger" id="author"></span></li>
      <li class="list-group-item">Tags: <span class="text-danger" id="tags"></span></li>
      <li class="list-group-item">Details: <span class="text-danger" id="description"></span></li>
    </ul>
    </div>
  </div>
</div>
